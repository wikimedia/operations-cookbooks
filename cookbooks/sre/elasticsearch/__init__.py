...
def argument_parser_base(name, title):
    ...
    Todo:
        Remove ``--nodes_has_lvs`` for a better implementation as this was introduced because
    ...
    parser.add_argument('--nodes_has_lvs', default=True, type=bool, help='True = has lvs, False = no lvs')
